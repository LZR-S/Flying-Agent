...
Use the playback controls to seek through the videos or watch in fullscreen.

Next, we will explore inspection, companionship, entertainment, and collaboration among multiple robots, helping a flying embodiment do useful and interesting things across more environments. We welcome discussion and collaboration.

**Code: Coming soon.** We are currently sharing a brief project overview and demos. We will continue to develop and open-source the code, documentation, and examples for more tasks.
